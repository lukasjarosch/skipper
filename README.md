<div align="center">
  ...
  <p>
    ...
    <a href="https://github.com/lukasjarosch/skipper/actions/workflows/test.yml"><img src="https://github.com/lukasjarosch/skipper/actions/workflows/test.yml/badge.svg?branch=main"></a>
  </p>
  <br/>
...
- [ ] Allow subset template generation in targets/classes
  ...
  - Maybe allow specifying required templates in a class and once the class is used, the template gets rendered automatically
